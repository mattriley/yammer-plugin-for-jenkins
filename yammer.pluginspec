Jenkins::Plugin::Specification.new do |plugin|
  ...
  #  :github => 'myuser/yammer-plugin' (without myuser it defaults to jenkinsci)
  #  :git => 'git://repo.or.cz/yammer-plugin.git'
  #  :svn => 'https://svn.jenkins-ci.org/trunk/hudson/plugins/yammer-plugin'
  plugin.uses_repository :github => "yammer-plugin-for-jenkins"
